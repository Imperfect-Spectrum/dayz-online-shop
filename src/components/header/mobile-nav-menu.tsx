...
interface MonileNavMenuProps {
  isOpen: boolean;
}

export default function MonileNavMenu({ isOpen }: MonileNavMenuProps) {
  return (
    <NavigationMenu
    ...
    >
      <NavigationMenuList className="font-medium flex flex-col justify-center items-start p-4 rounded-lg gap-6">
        <NavigationMenuItem>
        ...
        <NavigationMenuItem>
          ...
          <NavigationMenuContent>
            <ul className="grid w-[500px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[1000px]">
